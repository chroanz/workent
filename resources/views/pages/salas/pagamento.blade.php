...
$room = (object) [
        ...
        'description' => 'Uma sala de reunião com capacidade para 10 pessoas.',
        'price' => 892.45,
        'image' => '/img/exemplo-sala.png',
    ];
        ...
        <form method="POST" action="{{ route('payment.store') }}" class="d-flex flex-column gap-2">
            ...
            <div class="d-flex flex-wrap gap-2">
                <label class="btn-var-primary flex-grow-1" style="cursor: pointer;">
                    <input type="radio" name="payment_method" value="credit_card" class="d-none" onchange="updateSelection(this)"> Cartão de crédito
                </label>
                <label class="btn-var-primary flex-grow-1" style="cursor: pointer;">
                    <input type="radio" name="payment_method" value="pix" class="d-none" onchange="updateSelection(this)"> Pix
                </label>
                <label class="btn-var-primary flex-grow-1" style="cursor: pointer;">
                    <input type="radio" name="payment_method" value="debit_card" class="d-none" onchange="updateSelection(this)"> Cartão de débito
                </label>
            </div>
            <div class="d-flex gap-2 justify-content-between align-items-center">
                <div>
                <p class="fs-1">R$ {{ number_format($room->price, 2, ',', '.') }}</p>
                <input type="number" name="price" value="{{ $room->price }}" class="d-none">
                </div>
                <div>

...
@section('content')
  ...
  <div class="row justify-content-center align-items-center"> 
        ...
        <form method="POST" enctype="multipart/form-data">
          ...
          <div class="text-center mb-4 d-flex justify-content-center ">
            <div class="shadow-lg rounded text-white  h-100 rounded p-3" style=" width: 65%; background-color: #263AD1;">
              ...
              <h4 class="mt-2 mb-0">João</h4>
            </div>
          </div>

          <div class="mb-3">  
            <label for="name" class="form-label  fw-bold">Nome completo</label>
            <input type="text" name="name" class="form-control border border-dark " style="border-radius: 15px; padding:-10px;" required>
          </div>

          <div class="mb-3">
            <label for="email" class="form-label fw-bold">Email</label>
            <input type="email" name="email" class="form-control border border-dark" style="border-radius: 15px;"  required>
          </div>

          <div class="mb-3">
            <label for="birthday" class="form-label fw-bold">Data de nascimento</label>
            <input type="date" name="birthday" class="form-control border border-dark" style="border-radius: 15px;"  required>
          </div>

          <div class="mb-4">
            <label for="address" class="form-label fw-bold">Endereço</label>
            <textarea name="address" id="address" style="border-radius: 15px;" class="form-control border border-dark" rows="2"></textarea>
          </div>
    ...
    <div class="col-lg-6 text-center" >
      <img src="{{ asset('\img\Img Perfil.png') }}" alt="Usuário trabalhando" class="img-fluid rounded" style="max-height: 700px;">

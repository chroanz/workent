    ...
    <div class="row justify-content-center align-items-center">
      ...
      <div class="col d-flex justify-content-center">
        ...
        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="shadow-lg rounded text-white h-100 p-3" style="width: 65%; background-color: #263AD1;">
            ...
            <div class="d-flex justify-content-between">
              <button type="button" class="btn fw-semibold" style="width: 30%; color: #263AD1; border-color: #263AD1;" onclick="window.history.back();">
                Sair
              </button>
              <button type="submit" class="btn fw-bold"
                style="width: 30%; color: aliceblue; background-color: #263AD1;">Editar</button>
            </div>
          </form>
        </div>
      </div>

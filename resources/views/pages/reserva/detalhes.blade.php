...
<section class="detalhes-section d-flex p-2 justify-content-between">
    <section class="section-left h-100 d-flex flex-column p-4 justify-content-center align-items-center gap-4">
        <figure class="w-100">
        ...
        <ul class="lista">
            <li class="lista-item">Oito lugares</li>
    ...
    <section class="section-right h-100 p-5">
        <form action="" class="w-100 p-4 d-flex flex-wrap gap-4">
            <div class="espaco-40-por d-flex flex-column gap-2">
                ...
                <input class="input" type="date" value="2002-07-05" disabled>
            </div>
            <div class="espaco-40-por d-flex flex-column gap-2">
            ...
            <div class="w-100 d-flex flex-column gap-2">
                ...
                <input class="input" type="text" value="Lucas Barbosa" disabled>
            </div>

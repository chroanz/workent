...
@section('content')
  <div class="h-100 w-100 bg-evaluations d-flex justify-content-between align-items-center">
    <div class="image-side">
      <img class="img-fluid" src="{{ asset('img/avaliacao.png') }}" alt="Avaliação" />
    </div>
    <div class="form-side w-50 d-flex justify-content-start">
      <div class="bg-secondary-color form p-5">
        ...
        <form action="{{ route('evaluation.store', $rent->id) }}" method="POST" class="w-100 d-flex flex-column gap-3">
          @csrf
